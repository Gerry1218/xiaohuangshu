...
class AnimatedNotchBottomBarPage extends StatefulWidget {
  const AnimatedNotchBottomBarPage({super.key});

  @override
  State<AnimatedNotchBottomBarPage> createState() => _AnimatedNotchBottomBarPageState();
}

class _AnimatedNotchBottomBarPageState extends State<AnimatedNotchBottomBarPage> {
